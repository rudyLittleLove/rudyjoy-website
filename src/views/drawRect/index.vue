...
export default {
  ...
  mounted() {
    ...
    // 绘制图片
    chartObj.formatImg(this.imgBase64, img => {
      let x = 900
      let y = 50
      chartObj.push({
        type: 'img',
